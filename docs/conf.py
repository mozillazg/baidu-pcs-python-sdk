...
latex_documents = [
  ('index', 'BaiduPCS.tex', u'BaiduPCS Documentation',
   u'mozillazg', 'manual'),
]
...
man_pages = [
    ('index', 'baidupcs', u'BaiduPCS Documentation',
     [u'mozillazg'], 1)
]
...
texinfo_documents = [
  ('index', 'BaiduPCS', u'BaiduPCS Documentation',
   u'mozillazg', 'BaiduPCS', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'BaiduPCS'
epub_author = u'mozillazg'
epub_publisher = u'mozillazg'
epub_copyright = u'2013, mozillazg'
